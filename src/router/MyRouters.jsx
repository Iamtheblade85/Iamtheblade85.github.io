...
const MyRouters = () => {
  ...
  const allPages = [
    { path: "/", component: Welcome, type: "player-not-loggedin" },
    { path: "/login", component: Login, type: "player-not-loggedin" },
    { path: "/signup", component: Signup, type: "player-not-loggedin" },
    { path: "/home", component: Home, type: "player-loggedin" },
    { path: "/my-nfts", component: MyNftsPage, type: "wax-loggedin" },
    { path: "/staging-nfts", component: StagingNftsPage, type: "player-loggedin" },
    { path: "/player-profile", component: PlayerProfile, type: "player-loggedin" },
