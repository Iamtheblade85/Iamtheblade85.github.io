...
const MyNftCard = React.lazy(() => import("../../components/Nft/MyNftCard/MyNftCard"))
...
const MyNftsPage = () => {
  ...
  const importWithAnchor = (nft) => {
    ...
    User.anchorSession?.transact({
      ...
      .then(_ => {
        toast.success("NFT successfully imported. The list will be updated in a few seconds")
  ...
  return (
    <motion.div className={styles.container} initial={{ opacity: 0 }}
      ...
      <h2>My Nfts</h2>
      <p>{!myNfts || loader ? "You don't have" : `You have ${myNfts.length}`} nfts</p>
      <p>Below are the NFTs you have on your Wallet. You can import them on Smart Contract.</p>
      {loader ? (
